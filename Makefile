...
.PHONY: deps vendor build mysql-check mysql-cap-check rag-check rag-check-compare rag-test test check doc-diagrams doc-links agent-run agent-run-v5 agent-eval report-md run run-v5
